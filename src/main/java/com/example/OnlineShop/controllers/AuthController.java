...
import com.example.OnlineShop.payload.request.LoginRequest;
import com.example.OnlineShop.payload.request.SignupRequest;
import com.example.OnlineShop.payload.response.JwtResponse;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
        ...
        if (strRoles == null) {
            ...
            System.out.println("Role is not empty");
